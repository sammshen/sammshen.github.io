...
### Wacky Stuff
I am a believer that computer science as a pure mathematical/philsophical discipline was already completed by 1950. Everything after that was purely for improved operability (e.g. Operating Systems, HCI, Programming Languages, Networking, Databases etc.), which is of course super non-trivial (little old me wouldn't dare) and responsible for the impact of computing on modern living. 
- [Charles Babbage designs machinery with addressability, syntax, and operators](file:///Users/samuelshen/Documents/babbage.pdf) **without** electricity in 1837!!
...
This is what I contend is the mathematical/philosophical/engineering kernel of computer science. I believe every idea in computer science can be traced back to three words: addresses (indirection), syntax (memory), and operators (instructions)
